      ...
      <div className="relative z-10 container mx-auto px-4 py-20 min-h-screen flex items-center">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            <span className="text-white">Virtual Media Production</span>
            <br />
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8 italic tracking-wide">
            Capture Reality.{" "}
            <span className="text-cinema-gold">Create Worlds.</span>
          </p>

          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl leading-relaxed">
            We produce your ads and media using AI-enhanced motion capture,
            photogrammetry, and video generation. You subscribe. You send
            inputs.{" "}
            <span className="font-semibold text-cinema-gold">We deliver.</span>
          </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6 flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Predictable monthly access to production capacity and
                deliverables. We scope, schedule, and deliver on cadence.
              </p>
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6 flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Individual production kits for one-off projects. Fixed pricing,
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6 flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Curated photogrammetry assets, VP-ready environments, and AI
                media packs. Start with first-party, open to creators later.
              </p>
              <ul className="space-y-2 text-sm">
                <li className="flex gap-2">
                  <Check className="w-4 h-4 text-emerald-400 flex-shrink-0 mt-0.5" />
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6">
            ...
            <p className="text-sm text-gray-300">
              Choose a plan that fits your monthly output.
            </p>
          </Card>
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6">
            ...
            <p className="text-sm text-gray-300">
              Footage, products, references, brand guides.
            </p>
          </Card>
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6">
            ...
            <p className="text-sm text-gray-300">
              Mocap cleanup, photogrammetry, AI video & VFX.
            </p>
          </Card>
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-8 flex flex-col">
            ...
            <p className="text-sm text-gray-300 mb-4">
              Ideal for small agencies and freelancers testing virtual
              production.
            </p>
            <div className="mb-6">
            ...
            <ul className="space-y-3 text-sm flex-1 mb-6">
              <li className="flex gap-2">
                <Check className="w-4 h-4 text-emerald-400 flex-shrink-0 mt-0.5" />
                <span className="text-gray-300">
                  5 MoCap Basic sessions OR 2 outdoor scans
                </span>
              </li>
              <li className="flex gap-2">
                <Check className="w-4 h-4 text-emerald-400 flex-shrink-0 mt-0.5" />
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-cinema-gold p-8 flex flex-col relative">
            ...
            <p className="text-sm text-gray-300 mb-4">
              Perfect for mid-size agencies and production companies.
            </p>
            <div className="mb-6">
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-8 flex flex-col">
            ...
            <p className="text-sm text-gray-300 mb-4">
              Ideal for large brands, government projects, and high-volume
              productions.
            </p>
            <div className="mb-6">
            ...
            <ul className="space-y-3 text-sm flex-1 mb-6">
              <li className="flex gap-2">
                <Check className="w-4 h-4 text-emerald-400 flex-shrink-0 mt-0.5" />
                <span className="text-gray-300">
                  10 MoCap Basic + 4 outdoor scans
                </span>
              </li>
              <li className="flex gap-2">
                <Check className="w-4 h-4 text-emerald-400 flex-shrink-0 mt-0.5" />
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6">
            ...
            <p className="text-gray-300 text-sm">
              Always-on ad content, faster cycles.
            </p>
          </Card>
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6">
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6">
            ...
            <p className="text-gray-300 text-sm">
              Digitization & immersive exhibits.
            </p>
          </Card>
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6">
            ...
            <p className="text-gray-300 text-sm">
              High-impact promos, motion analysis.
            </p>
          </Card>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h3 className="text-2xl font-bold text-white mb-4">
                Ready to ship cinematic content on a subscription?
              </h3>
              <p className="text-gray-300 mb-6">
                Tell us about your brand and monthly goals. We'll propose the
                right plan.
              </p>
              <div className="space-y-3">
                <a
                  className="inline-flex items-center gap-2 text-cinema-gold hover:text-yellow-300 transition-colors"
                  href="mailto:hello@virtualproduction.com"
                >
