...
import { Check, CreditCard, ArrowRight, Package2, Clock, Zap, Star, Video, Camera, Palette } from "lucide-react";
...
export default function PayAsYouGoPage() {
  ...
  const getKitIcon = (kitKey: PayAsYouGoKit) => {
    if (kitKey.includes("mocap")) return <Video className="w-6 h-6 text-cinema-gold" />;
    if (kitKey.includes("photoscan")) return <Camera className="w-6 h-6 text-cinema-gold" />;
    if (kitKey.includes("videoBoost")) return <Palette className="w-6 h-6 text-cinema-gold" />;
  ...
  const getCategoryTitle = (category: string) => {
    switch (category) {
      case "mocap": return "Motion Capture Kits";
      case "photoscan": return "Photogrammetry Kits";
      case "video": return "Video Enhancement Kits";
      default: return "Production Kits";
    }
  };

  const getCategoryDescription = (category: string) => {
    switch (category) {
      case "mocap": return "AI-powered motion capture with professional cleanup and processing";
      case "photoscan": return "High-quality 3D scanning for objects, environments, and locations";
      case "video": return "AI video enhancement, upscaling, and style transfer services";
      default: return "Professional production services";
    }
  };
    ...
    <div className="min-h-screen bg-cinema-dark">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Pay-As-You-Go <span className="text-cinema-gold">Production Kits</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Individual production kits for one-off projects. Fixed pricing, no subscription required. 
            Perfect for testing our workflow or handling specific project needs.
          </p>
        </div>
          ...
          {["mocap", "photoscan", "video"].map((category) => (
            <TabsContent key={category} value={category} className="mt-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-300">{getCategoryDescription(category)}</p>
              </div>

              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {getKitsByCategory(category).map(([key, kit]) => {
                  const isSelected = key === selectedKit;
                  const isPopular = key === "mocapBasic" || key === "photoscanOutdoor" || key === "videoBoostPro";
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-center">
                        ...
                        <div className="mb-4">
                          <div className="text-3xl font-bold text-white mb-1" data-testid={`text-price-${key}`}>
                            {kit.price}
                          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">Select the production kit that matches your project needs and budget.</p>
            </Card>
            ...
            <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">Pay the fixed kit price - no subscription, no hidden costs, no surprises.</p>
            </Card>
            ...
            <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">Our AI-powered team handles capture, cleanup, and processing to specifications.</p>
            </Card>
            ...
            <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-6 text-center">
              ...
              <p className="text-gray-300 text-sm">Receive production-ready assets in 3-12 days depending on kit complexity.</p>
            </Card>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-white text-center mb-12">Pay-As-You-Go vs Subscription</h2>
            ...
            <Card className="bg-white/5 backdrop-blur-sm border-white/10 p-8">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-300">Perfect for one-off projects</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-emerald-400 flex-shrink-0 mt-0.5" />
